import type { AgentMessage, ToolSchema } from "../query-engine/provider.js";
import type { ContextTokenCountInput, ContextTokenCounter } from "./types.js";
...
export class ProviderTokenCounter implements ContextTokenCounter {
    public constructor(private readonly port: MessageTokenCounterPort) {}
    ...
    public async count(input: ContextTokenCountInput): Promise<number> {
        ...
        const tokenCount = await this.port.countTokens(messages, [...input.tools]);

...
//                         "不确定时不要输出纠错。",
//                         "输出只能包含根字段 corrections；corrections 必须是数组。",
//                         "每条纠错只能包含 turnId、original、replacement、confidence、reason，不得添加其他字段。",
//                         "turnId、original、replacement、reason 必须是非空字符串；confidence 必须是 0 到 1 的数字。",
//                         [
//                             "EXAMPLE INPUT:",
//                             "[",
//                             "  {",
...
//                         ].join("\n"),
//                         [
//                             "NO CORRECTION JSON OUTPUT:",
//                             "{",
//                             "  \"corrections\": []",
//                             "}",
//                         ].join("\n"),
//                         "只能返回一个 JSON 对象；不得使用 Markdown 代码块，不得附加解释文字。",
//                     ].join("\n"),

...
const fieldLabels: Record<string, string> = {
    ...
    durationMs: "耗时（毫秒）",
    operation: "操作",
    userInputCharacterCount: "用户输入字符数",
    answerCharacterCount: "回答字符数",
    characterCount: "字符数",
    turnCount: "对话轮次数",
    clusterCount: "聚类数",
    questionCount: "问题数",
...
export function FieldDescriptions({ data, omitKeys = emptyKeys, markdownContent = false }: FieldDescriptionsProps) {

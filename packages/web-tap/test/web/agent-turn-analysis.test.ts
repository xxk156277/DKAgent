    ...
    it("aggregates a completed Tool Turn and keeps semantic quality unknown", () => {
        const result = analyze([
            ...
            traceEvent(
                ...
                "start",
                { input: { step: 1 } },
                { spanId: "step-1", parentSpanId: "turn", step: 1 },
            ),
            traceEvent(
                "event-3",
                "model.request",
            ...
            traceEvent(
                ...
                "end",
                { output: {} },
                { spanId: "model-1", parentSpanId: "step-1", step: 1, durationMs: 20 },
            ),
            traceEvent(
                "event-6",
                "tool.call",
                "start",
                { input: { id: "call-1", name: "weather" } },
            ...
            traceEvent(
                ...
                "end",
                { output: {} },
                { spanId: "tool-1", parentSpanId: "step-1", step: 1, durationMs: 10 },
            ),
            traceEvent(
                "event-9",
            ...
            traceEvent(
                ...
                "end",
                { output: {} },
                { spanId: "step-1", parentSpanId: "turn", step: 1, durationMs: 40 },
            ),
            traceEvent(
                "event-11",
                "agent.turn",
